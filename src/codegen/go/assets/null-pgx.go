...
func Nullable(target nullableTarget) any        { return nullTarget{value: target} }
func ScanTargets(targets ...any) pgx.RowScanner { return scanTargets{targets: targets} }
...
func JSONValue(value nullableValue) any { return jsonValue{value: value} }
...
func (p *nullScanPlan) SetNext(next pgtype.ScanPlan) { p.next = next }
...
func (p *nullEncodePlan) SetNext(next pgtype.EncodePlan) { p.next = next }
