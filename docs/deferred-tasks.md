...
| Asking PostgreSQL to resolve a type (`PREPARE`) | `docs/type-resolution-delegation.md` — Stages 1–2 landed 2026-08-24 (`src/query/type-delegation.ts`), Stages 3–5 open |
