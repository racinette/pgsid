...
func (n Null[T]) SQLUnderlying() any {
	return n.V
}
func (n Null[T]) SQLValid() bool {
	return n.Valid
}
func (n *Null[T]) SQLTarget() any {
	return &n.V
}
...
func (n Undefined[T]) IsZero() bool {
	return !n.Set
}
...
func (n NullOrUndefined[T]) IsZero() bool {
	return !n.Set
}
