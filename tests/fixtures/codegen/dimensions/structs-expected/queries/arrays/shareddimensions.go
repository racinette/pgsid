...
type SharedDimensionsParams struct {
	Shared pgtype.Array[pgsid.Null[int32]] `db:"shared"`
}

func (q *Queries) SharedDimensions(ctx context.Context, params SharedDimensionsParams) error {
	arrayInput1, err := pgsidpgx.ValidateArrayInput[pgsid.Null[int32]](params.Shared, []int{2}, "SharedDimensions", "shared", false)
	if err != nil {
		return err
	}
