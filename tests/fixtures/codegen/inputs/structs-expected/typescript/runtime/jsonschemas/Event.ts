...
export function isEvent(value: unknown): value is import("../../types/jsonschemas/Event.js").Event {
    return _schema0.is(value);
}
export function validateEvent(value: unknown): _ValidationResult {
