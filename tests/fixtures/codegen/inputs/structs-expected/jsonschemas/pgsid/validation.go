...
const schemaResources = "{\"pgsid:///jsonschemas/Audit.json\":{\"type\":\"object\",\"required\":[\"actor\",\"label\"],\"properties\":{\"actor\":{\"type\":\"integer\",\"maximum\":10},\"label\":{\"type\":\"string\"},\"next\":{\"$ref\":\"#\"}},\"additionalProperties\":false},\"pgsid:///jsonschemas/Event.json\":{\"type\":\"object\",\"required\":[\"actor\"],\"properties\":{\"actor\":{\"type\":\"integer\",\"minimum\":1},\"label\":{\"type\":\"string\"},\"next\":{\"$ref\":\"#\"}},\"additionalProperties\":false},\"pgsid:///jsonschemas/Maybe.json\":{\"type\":[\"object\",\"null\"],\"properties\":{\"actor\":{\"type\":\"integer\",\"minimum\":1}},\"additionalProperties\":false},\"pgsid:///jsonschemas/Numbers.json\":{\"type\":\"array\",\"items\":{\"type\":\"integer\",\"minimum\":1}}}"
