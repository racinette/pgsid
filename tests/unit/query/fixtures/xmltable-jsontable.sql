...
-- @unwitnessable 5: '$.b' is NOT in the document — an EXISTS column answers a
--   missing member with false rather than NULL (measured), and only an
--   explicit UNKNOWN ON ERROR could make it NULL
